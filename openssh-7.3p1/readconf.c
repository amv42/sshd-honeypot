...
/* sshd-honeypot: add sshd_config options */
    omsHost, omsPort, omsUsername, osshdVersion, oTcpForwardingHost, oTcpForwardingPort,
/* sshd_honeypot: end */
...
/* sshd_honey sshd_config options */
    { "mshost", omsHost},
    { "msport", omsPort},
    { "msusername", omsUsername},
    { "sshdversion", osshdVersion},
	{ "tcpForwardingHost", oTcpForwardingHost},
	{ "tcpForwardingPort", oTcpForwardingPort},
/* sshd_honey end */
